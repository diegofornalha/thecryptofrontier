...
export function PreviewBanner() {
    ...
    useEffect(() => {
        ...
        const isPreviewMode = window.location.hostname.includes('deploy-preview') ||
    ...
    if (!isPreview)
        return null;
    return (<div className="bg-yellow-500 text-black px-4 py-2 text-center sticky top-0 z-50">
