...
export default function FeaturedClient({ featuredPosts }) {
    ...
    return (<div className="w-full bg-white p-4">
      <div className="space-y-4">
        {featuredPosts.slice(0, itemsToShow).map((post) => (<article key={post._id} className="border-b border-gray-200 pb-4 last:border-b-0">
