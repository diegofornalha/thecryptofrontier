...
export default function NewsHeader() {
    ...
    return (<>
          ...
          <div className="flex items-center justify-between h-[70px]">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="w-1/4 flex justify-start">
                <Link href="/buscas" className="text-gray-700 hover:text-blue-500 p-2 transition-colors" aria-label="Buscar">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" width="24" height="24" className="w-6 h-6" aria-hidden="true" role="img">
                    <path d="M958.484 910.161l-134.564-134.502c63.099-76.595 94.781-170.455 94.72-264.141
                             ...
                             208.486-96.963 0.522-0.061 1.024 0 1.536 0.041-25.313-8.684-51.794-13.087-78.408-13.066z" fill="currentColor"/>
                  </svg>
                </Link>
              </div>
              ...
              <div className="w-1/4 flex justify-end items-center space-x-2">
                <LanguageSwitcher />
                <button className="text-gray-700 hover:text-blue-500 p-2 transition-colors" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Menu">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 900" width="24" height="24" className="w-6 h-6" aria-hidden="true" role="img">
                    <path d="M136.509 145.673h171.039v170.998h-171.039v-170.998z
                             ...
                             M716.452 725.574h171.039v171.039h-171.039v-171.039z" fill="currentColor"/>
                  </svg>
                </button>
              </div>
            </div>
      ...
      {mobileMenuOpen && (<div className="fixed top-[70px] left-0 right-0" style={{ zIndex: 9998 }}>
          <nav className="bg-white border-b border-gray-100 shadow-lg">
            <div className="max-w-7xl mx-auto px-4 py-6">
              {/* Grid Layout para Desktop */}
              <div className="hidden lg:grid lg:grid-cols-4 lg:gap-6">
                <Link href="/" className="group p-4 rounded-lg hover:bg-gray-50 transition-colors text-center" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/blog" className="group p-4 rounded-lg hover:bg-gray-50 transition-colors text-center" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/buscas" className="group p-4 rounded-lg hover:bg-gray-50 transition-colors text-center" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/studio" className="group p-4 rounded-lg hover:bg-gray-50 transition-colors text-center" onClick={() => setMobileMenuOpen(false)}>
