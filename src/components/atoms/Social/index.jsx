...
export default function Social(props) {
    ...
    const annotations = fieldPath
        ...
        : {};
    return (<Link id={elementId} className={classNames('sb-component', 'sb-component-block', 'sb-component-social', 'inline-flex', 'items-center', 'justify-center', 'transition', 'duration-200', 'ease-in', 'hover:-translate-y-1', className)} href={url} aria-label={altText} {...annotations}>
