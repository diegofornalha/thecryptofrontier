  ...
  const handleFileUpload = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      setFormData({
        ...
        excerpt: resumoMatch?.[1] || '',
        tags: tagsMatch?.[1] || '',
        category: categoriasMatch?.[1]?.split(',')[0]?.trim() || '',
        metaTitle: seoTitleMatch?.[1] || '',
        metaDescription: seoDescMatch?.[1] || ''
      });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="bitcoin, blockchain, defi (separadas por vírgula)"
                  />
                </div>
                <div>
