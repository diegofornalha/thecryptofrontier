#!/usr/bin/env python3
"""
Script para atualizar o conteúdo do post XRP diretamente
"""

# Conteúdo completo corrigido para o post
corrected_content = [
    {
        "_type": "block",
        "_key": "66dacb1a",
        ...
        "children": [
            {
                "_type": "span",
                "_key": "span5",
                "text": "Steingraber apontou que o XRP subiu de US$ 2,17 para US$ 2,28 com apenas US$ 17 milhões em influxos líquidos. Isso se traduz em um aumento de US$ 11 bilhões na capitalização de mercado do XRP, com base no fornecimento total de 100 bilhões, em 7 de junho."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "asset": {
            "_type": "reference",
            "_ref": "image-5dbd9d5d-Gs7ldW9WsAAnJLq"
        },
    ...
    },
    {
        ...
        "alt": "Gráfico mostrando o domínio dos fluxos de saída na capitalização de mercado do XRP | CoinGlass",
...
import json
print("✅ Conteúdo corrigido gerado!")
print(f"📝 Total de blocos: {len(corrected_content)}")
print("\n🔍 Links corrigidos:")
print("  1. 'a briga entre' - Link para artigo sobre Musk/Trump")
print("  2. 'ETFs spot XRP' - Link para artigo sobre ETFs")
print("  3. 'alguns especulam' - Link para artigo sobre previsões")
print("  4. 'em um relatório anterior' - Link para artigo sobre Kraken")

# Salvar conteúdo para uso
with open('corrected_xrp_content.json', 'w', encoding='utf-8') as f:
    json.dump(corrected_content, f, ensure_ascii=False, indent=2)
