...
export class WriterAgent extends BaseMCPAgent {
    ...
    generateArticleStructure(topic, research) {
        return {
            introduction: {
    ...
    generateTitle(topic, research) {
        ...
        if (((_a = research.trends) === null || _a === void 0 ? void 0 : _a.sentiment) === 'positive') {
    ...
    async writeContent(structure, research) {
        const sections = [];
        // Introdução
    ...
    createOverviewSection(topic, research) {
    ...
    createAnalysisSection(research) {
    ...
    createOpportunitiesSection(research) {
        var _a;
        const opportunities = ((_a = research.detailed_analysis) === null || _a === void 0 ? void 0 : _a.opportunities) || [
            'Investimento em projetos inovadores',
            'Participação em governança descentralizada',
            'Yield farming e staking'
        ];
        return opportunities.map((opp, index) => `${index + 1}. **${opp}**: Explore as possibilidades desta estratégia.`).join('\n\n');
    }
    createRisksSection(research) {
        var _a;
        const risks = ((_a = research.detailed_analysis) === null || _a === void 0 ? void 0 : _a.risks) || [
    ...
    optimizeSEO(title, content, keywords) {
    ...
    generateTags(topic, research, keywords) {
        var _a;
        const tags = new Set();
        // Tags do tópico
    ...
    calculateConfidence(result) {
        ...
        if (wordCount > 1200)
            confidence += 0.1;
        // Avalia SEO
        if (result.seo.keywords.length >= 5)
            confidence += 0.05;
