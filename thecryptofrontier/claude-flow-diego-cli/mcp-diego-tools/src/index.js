...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        console.error(`[DEBUG] Content is array?`, Array.isArray(result === null || result === void 0 ? void 0 : result.content));
        ...
        // Tratamento de erro
        const toolLogger = logger.forTool(name);
        toolLogger.error('Erro ao executar ferramenta', error, args);
        return {
            content: [{
                    type: 'text',
