/**
 * Configuração centralizada do DiegoTools - Versão Adaptada
 */
...
function createConfig() {
    const rawConfig = {
        ...
        mem0: {
            ...
            baseUrl: process.env.MEM0_BASE_URL || 'http://localhost:3002'
        },
        puppeteer: {
...
/**
 * Validar configurações obrigatórias (GITHUB_TOKEN removido)
 */
export function validateRequiredConfig() {
    const missing = [];
    // Nenhuma configuração é obrigatória nesta versão adaptada
    return missing;
}
/**
