...
import {
  handleGuardianAnalyze,
  handleGuardianStatus,
  handleGuardianHistory,
  handleGuardianHealth
} from '../tools/guardian/index.js';
import {
  handleGuardianBackupCreate,
  handleGuardianBackupStatus,
  handleGuardianCleanupSuggestions,
  handleGuardianCleanupExecute,
  handleGuardianLogsStatus,
  handleGuardianLogsRotate,
  handleGuardianAgentsList
} from '../tools/guardian/enhanced-tools.js';
import {
  handleAgentsList
