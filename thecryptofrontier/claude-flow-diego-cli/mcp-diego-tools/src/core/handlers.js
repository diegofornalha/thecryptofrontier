...
export async function ensureBrowser() {
    try {
        ...
        throw new MCPError(ErrorCode.BROWSER_NOT_INITIALIZED, 'Failed to initialize browser', error);
    }
}
// ==================== Puppeteer Handlers ====================
export async function handleNavigate(params) {
    ...
    }, CONFIG.puppeteer.defaultTimeout, `Navigation to ${params.url} timed out`);
...
export async function handleClick(params) {
    ...
    }, 5000, `Element ${params.selector} not found or not clickable`);
...
export async function handleType(params) {
    ...
    }, 5000, `Element ${params.selector} not found`);
