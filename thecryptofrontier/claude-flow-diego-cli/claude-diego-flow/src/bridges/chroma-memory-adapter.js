...
export class ChromaMemoryAdapter {
    constructor(chromaUrl = 'http://chroma-db:8000', port = 3002) {
        this.app = express();
        this.port = port;
                ...
                if (results.ids && results.ids[0]) {
                    for (let i = 0; i < results.ids[0].length; i++) {
                        mcpResults.push({
                            ...
                            created_at: (_a = results.metadatas[0][i]) === null || _a === void 0 ? void 0 : _a.created_at,
                ...
                if (results.ids) {
                    for (let i = 0; i < results.ids.length; i++) {
                        mcpMemories.push({
                            ...
                            created_at: (_a = results.metadatas[i]) === null || _a === void 0 ? void 0 : _a.created_at,
