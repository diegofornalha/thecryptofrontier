...
async function testMemoryAgent() {
    ...
    try {
        ...
        await logAgent.end('Memory Enhanced Agent', searchTaskId, 'completed', undefined, {
            ...
            topResult: ((_a = results.results[0]) === null || _a === void 0 ? void 0 : _a.content) || 'Nenhum resultado'
        });
    ...
    try {
        ...
        await logAgent.start('Memory Enhanced Agent', AgentType.CUSTOM, consolidationTaskId, 'Consolidação de memórias duplicadas sobre AgentLog', {
        ...
        // Registrar conclusão
        await logAgent.end('Memory Enhanced Agent', consolidationTaskId, 'completed', undefined, {
            memoriesAnalyzed: 17,
        ...
        await logAgent.end('Memory Enhanced Agent', consolidationTaskId, 'error', error.message);
    }
