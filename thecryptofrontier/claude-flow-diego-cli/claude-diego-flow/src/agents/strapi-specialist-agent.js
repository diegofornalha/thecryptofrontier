    ...
    async learnAboutEnvironment() {
        ...
        try {
            ...
            if (await this.fileExists(strapiPackagePath)) {
                ...
                const strapiVersion = ((_a = packageJson.dependencies) === null || _a === void 0 ? void 0 : _a['@strapi/strapi']) || 'unknown';
    ...
    async loadStrapiConfig() {
        ...
        try {
            ...
            if (await this.fileExists(packageJsonPath)) {
                ...
                console.log(`📦 Strapi version: ${((_a = pkg.dependencies) === null || _a === void 0 ? void 0 : _a['@strapi/strapi']) || 'unknown'}`);
            }
