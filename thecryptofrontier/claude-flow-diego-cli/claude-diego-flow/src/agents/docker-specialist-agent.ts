...
export class DockerSpecialistAgent extends Agent {
    ...
    private async analyzeDockerfiles(): Promise<string> {
    ...
    private async analyzeDockerfileContent(filePath: string, content: string): Promise<string> {
    ...
    private async analyzeComposeFiles(): Promise<string> {
        ...
        for (const file of composeFiles) {
            ...
            if (content.includes('version:')) {
                const version = content.match(/version:\s*['"]?(\d+\.?\d*)/)?.[1];
    ...
    private async checkContainers(): Promise<string> {
    ...
    private async analyzeImages(): Promise<string> {
    ...
    private async optimizeDocker(): Promise<string> {
    ...
    private async generalDockerAnalysis(): Promise<string> {
