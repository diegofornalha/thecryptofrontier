...
export class GuardianPDCASystem {
    ...
    async startCycle(title, objectives, autoExecute = false) {
        ...
        const cycle = {
            ...
            startDate: new Date(),
            status: 'planning',
            parentCycleId: (_a = this.activeCycle) === null || _a === void 0 ? void 0 : _a.id
        };
    ...
    async compareMetric(metric, execution) {
        var _a;
        const latestValue = ((_a = execution.realTimeMetrics
            .filter(m => m.metricId === metric.id)
            .pop()) === null || _a === void 0 ? void 0 : _a.value) || 0;
    ...
    saveMetricsToHistory(cycle) {
        ...
        const metrics = cycle.plan.metrics.map(metric => {
            ...
            return {
                metric,
                value: (latestValue === null || latestValue === void 0 ? void 0 : latestValue.value) || 0,
                timestamp: (latestValue === null || latestValue === void 0 ? void 0 : latestValue.timestamp) || new Date()
            };
        });
    ...
    generateEvolutionReport() {
        ...
        const successRate = cycles.reduce((acc, cycle) => {
            var _a;
            return acc + (((_a = cycle.check) === null || _a === void 0 ? void 0 : _a.performance.overallScore) || 0);
        }, 0) / cycles.length;
        report += `\n## Taxa de Sucesso Geral: ${successRate.toFixed(2)}%\n`;
        // Aprendizados principais
        report += '\n## Principais Aprendizados\n\n';
        const allLearnings = cycles
            .flatMap(c => { var _a; return ((_a = c.check) === null || _a === void 0 ? void 0 : _a.learnings) || []; })
