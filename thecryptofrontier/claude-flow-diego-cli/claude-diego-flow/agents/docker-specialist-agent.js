...
exports.DockerSpecialistAgent = void 0;
 ...
 * - CI/CD com Docker
 */
class DockerSpecialistAgent extends agent_1.Agent {
    constructor() {
        super({
        ...
        try {
            ...
            if (Object.keys(portMappings).length > 0) {
                try {
                    ...
                    const memoryData = {
                        user_id: memory_constants_1.MemoryNamespaces.AGENT('docker-specialist'),
...
exports.DockerSpecialistAgent = DockerSpecialistAgent;
