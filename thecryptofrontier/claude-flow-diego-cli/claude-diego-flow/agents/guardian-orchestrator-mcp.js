...
exports.GuardianOrchestratorMCP = void 0;
const agent_1 = require("../core/agent");
const mcp_bridge_1 = require("../mcp/mcp-bridge");
const mcp_integration_1 = require("../mcp/mcp-integration");
const docker_specialist_agent_1 = require("./docker-specialist-agent");
const nextjs_specialist_agent_1 = require("./nextjs-specialist-agent");
const strapi_specialist_agent_1 = require("./strapi-specialist-agent");
const claude_code_specialist_agent_1 = require("./claude-code-specialist-agent");
const mem0_specialist_agent_1 = require("./mem0-specialist-agent");
// import { CleanupSpecialistAgent } from './cleanup-specialist-agent';
const child_process_1 = require("child_process");
const util_1 = require("util");
const fs = __importStar(require("fs/promises"));
const path = __importStar(require("path"));
const guardian_memory_system_1 = require("../core/guardian-memory-system");
const guardian_pdca_system_1 = require("../core/guardian-pdca-system");
const guardian_api_service_1 = require("../services/guardian-api-service");
/**
 ...
 */
class GuardianOrchestratorMCP extends agent_1.Agent {
    constructor() {
        super({
        ...
        this.mcpBridge = new mcp_bridge_1.MCPBridge();
        this.memoryUserId = 'guardian-orchestrator';
        this.pdcaSystem = new guardian_pdca_system_1.GuardianPDCASystem();
    }
    async initialize() {
        ...
        try {
            ...
            this.memory = new guardian_memory_system_1.GuardianMemorySystem(this.mcpBridge, this.memoryUserId);
            console.log('🧠 Sistema de memória automática ativado');
            // Inicializar API service
            this.apiService = new guardian_api_service_1.GuardianAPIService(this.memory);
        ...
        const dockerAgent = new docker_specialist_agent_1.DockerSpecialistAgent();
        const nextjsAgent = new nextjs_specialist_agent_1.NextJSSpecialistAgent();
        const strapiAgent = new strapi_specialist_agent_1.StrapiSpecialistAgent();
        const claudeCodeAgent = new claude_code_specialist_agent_1.ClaudeCodeSpecialistAgent();
        const mem0Agent = new mem0_specialist_agent_1.Mem0SpecialistAgent();
    ...
    async checkGitHubIssues() {
        console.log('🔍 Checking GitHub issues...');
        try {
            const issues = await this.mcpBridge.callTool(mcp_integration_1.MCP_TOOLS.GITHUB_LIST_ISSUES, {
...
exports.GuardianOrchestratorMCP = GuardianOrchestratorMCP;
